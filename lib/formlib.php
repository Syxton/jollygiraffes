...
function get_form($formname, $vars = null, $identifier = "") {
    ...
    switch ($formname) {
        ...
        case "add_edit_expense":
            ...
            if ($expenses = get_db_result("SELECT * FROM billing_payments WHERE pid='" . $vars["pid"] . "' AND aid=0 ORDER BY timelog DESC")) {
                ...
                while ($expense = fetch_row($expenses)) {
                    $program_expense_form .= '
                <tr class="expense_' . $expense["payid"] . '">
        ...
        case "add_edit_account":
            ...
            $meal_status[0] = new stdClass();
            $meal_status[1] = new stdClass();
            $meal_status[2] = new stdClass();
            $meal_status[0]->value = "paid";
            $meal_status[0]->display = "Paid";
            $meal_status[1]->value = "reduced";
            $meal_status[1]->display = "Reduced";
            $meal_status[2]->value = "free";
            $meal_status[2]->display = "Free";
        ...
        case "attach_doc":
            ...
            if ($tags = get_db_result("SELECT * FROM documents_tags WHERE tag != 'avatar' ORDER BY tag")) {
                while ($tag = fetch_row($tags)) {
                    $listoftags .= empty($listoftags) ? $tag["title"] : "," . $tag["title"];
                }
            }
                    ...
                    <form name="' . $formname . '_form' . $identifier . '">
                        ...
                        <table style="width:100%">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tag" class="fields tag tags_editor" value="' . $selected . '" />
                                    <input name="tags_list" type="hidden" class="tags_list" value="' . $listoftags . '" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea class="fields" style="width:100%;height:80px;" name="description">' . $description . '</textarea>
                                </td>
                            </tr>
                        </table>
        ...
        case "attach_note":
            ...
            $form = '
        <div id="attach_note' . $identifier . '" title="' . $title . '" style="display:none;">
            <form name="' . $formname . '_form' . $identifier . '">
                ' . $fields . '
                <table style="width:100%">
                    <tr>
                        ...
                        <td>
                            <input id="tag_' . $identifier . '" type="text" name="tag" class="fields tag tags_editor" value="' . $selected . '" />
                            <input name="tags_list" type="hidden" class="tags_list" value="' .  $listoftags . '" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="notify">Notify Parent</label>
                        </td>
                        <td>
                            ' . make_select_from_object("notify", $notify_array, "value", "display", "fields", $notify) . '
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ' . make_select_from_object("persistent", $notify_array, "value", "display", "fields", $persistent) . '
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">
                        ...
                        <td>
                            <textarea class="fields" style="width:100%;height:160px;" name="note">' . $note . '</textarea>
                        </td>
                    </tr>
                </table>
                <button class="bottom-right" type="submit" onclick="var button = $(this); $(this).button(\'option\', \'disabled\', true); $.ajax({
                    type: \'POST\',
                    url: \'ajax/ajax.php\',
                    timeout: 10000,
                    error: function(x, t, m) {
        ...
        case "create_invoices":
            ...
            $refresh[0] = new stdClass();
            $refresh[1] = new stdClass();
            $refresh[0]->value = "1";
